...
Strategy:
  - Use p40/p60 input boxes (tight enough that baseline stays well below saturation)
...
def main():
    ...
    ap.add_argument("--plo",    type=float, default=40)
    ap.add_argument("--phi",    type=float, default=60)
