"""
run_nnenum_control.py

Same as run_nnenum_full.py but uses set_control_settings() preset.
Results saved to /tmp/nnenum_control_results.json.
"""
...
TIMEOUT = 1800
OUTFILE = "/tmp/nnenum_control_results.json"
