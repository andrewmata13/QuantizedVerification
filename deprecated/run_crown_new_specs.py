"""
Run alpha-beta CROWN on the new/changed specs:
  - HC baseline + latent3 spec_10 (Y_3 >= 3.7726)
  - Hopper baseline + latent3 spec_9 (Y_0 >= 3.90), spec_10 (Y_1 >= 6.50)
"""
...
TIMEOUT = 1800
OUTFILE = "/tmp/crown_new_specs.json"
...
for env, net_label, onnx_path, spec_ids in JOBS:
    key = f"{env} / {net_label}"
