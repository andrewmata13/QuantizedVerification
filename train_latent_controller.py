...
def train_latent_controller(encoder, controller, X, Y, epochs=20, bs=1024, lr=3e-4, device="cpu"):
...
def main():
    ...
    controller = LatentController(args.latent_dim, hidden=args.controller_hidden, out_dim=act_dim)

    print("Everything is set...")

    # Train an initial latent controller with the initial grid
    train_latent_controller(
        encoder, controller, X, Y,
